...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "boilerplate-api"

    POSTGRES_SERVER: str = os.getenv("POSTGRES_USER", "localhost")
    POSTGRES_PORT: str = os.getenv("POSTGRES_PORT", "5432")
    POSTGRES_USER: str = os.getenv("POSTGRES_USER", "boilerplate")
    POSTGRES_PASSWORD: str = os.getenv("POSTGRES_USER", "boilerplate")
    POSTGRES_DB: str = os.getenv("POSTGRES_USER", "boilerplate")
    ...
    USER_TEST_FIRSTNAME: str
    USER_TEST_PASSWORD: str

    USER_ADMIN_EMAIL: EmailStr
    USER_ADMIN_FIRSTNAME: str
